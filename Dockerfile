...
#     CGO_ENABLED=1 GOARCH=$TARGETARCH GOOS=linux go build -o /bin/server .


# FROM python:3.8-slim-buster AS parse
# WORKDIR /app
# COPY parse.py /app
# COPY save.xml /app
# RUN python parse.py
...
# Use a consistent base image for both build and runtime stages
